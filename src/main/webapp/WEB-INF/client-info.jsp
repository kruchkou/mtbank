            ...
            <div id="content-body" class="container-fluid d-flex">
                <div class="col-12">
                    ...
                    <div class="form-group">
                        ...
                        <span>${empty client.workPlace ? 'не указано' : client.workPlace}</span>
                    </div>
                    <div class="form-group">
                        <label>Должность</label>
                        <span>${empty client.workPosition ? 'не указано' : client.workPosition}</span>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <span>${client.passportAddress}</span>
                    </div>
                    <div class="form-group">
