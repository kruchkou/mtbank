...
import by.bsuir.alexey.mtbank.service.*;
...
import by.bsuir.alexey.mtbank.service.util.validator.DateValidatorValueProvider;
...
public final class GoToCreateClientCommand implements Command {
    ...
    public void execute(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException, ServiceException {
        ...
        req.setAttribute("regexp_work", regexpPropertyUtil.getProperty("regexp.work"));
        ...
        req.getRequestDispatcher("WEB-INF/client-create.jsp").forward(req, resp);
    }
}
